  ...
  <body>
     ...
     <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      ...
      <header id="headerSection">
          <div class="overlay">
             ...
             <h1 class="text-center">Pending Papers</h1>
    ...
    $url = "dijkstra.ug.bcc.bilkent.edu.tr" ;
        ...
        $username = "PeloChan";
            ...
            $sql = $conn->query("SELECT S.title FROM scientific_research_paper S NATURAL JOIN paper_evaluation E WHERE E.reviewer_username = '$username'");
                            ...
                            while($data = $sql->fetch_assoc() )
                            {
                                        ...
                                        echo "<div class='row-fluid'>";
                                            echo "<div class='col-10'>";
                                                echo "<p>" . "Pending Paper: ". $data['title'] ." " ."</p>" ;
                                            echo "</div>";
                                        echo "</div>";
